<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Tambah Penugasan Mengajar Baru') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Informasi Penugasan Mengajar
                    </h3>

                    <form method="POST" action="{{ route('admin.teaching_assignments.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            @if ($teachers->isEmpty())
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">Tidak ada guru ditemukan.
                                    Pastikan ada user dengan peran 'guru'.</p>
                            @endif
                        </div>
