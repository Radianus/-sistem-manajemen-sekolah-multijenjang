<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Manajemen Penugasan Mengajar') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 sm:mb-0">Daftar Penugasan
                            Mengajar</h3>
                                ...
                                @forelse ($assignments as $assignment)
                                    <tr
                                        ...
                                        <td class="py-4 px-6 flex items-center space-x-3">
                                            <a href="{{ route('admin.teaching_assignments.edit', $assignment) }}"
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                            <form
                                                action="{{ route('admin.teaching_assignments.destroy', $assignment) }}"
                                                method="POST"
                                ...
                                @empty
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td colspan="6"
                                            ...
                                            Tidak ada penugasan mengajar ditemukan.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
