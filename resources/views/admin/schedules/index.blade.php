                        ...
                        <div>
                            ...
                            @if (Auth::user()->hasRole('admin_sekolah') || Auth::user()->hasRole('guru'))
                                <label for="class_filter"
                                    class="text-gray-700 dark:text-gray-300 ml-4 mr-2 mb-2 sm:mb-0">Filter
                                    Kelas:</label>
                        ...
                        <div
                            ...
                            <table
                                ...
                                <thead
                                    ...
                                    <tr>
                                        <th scope="col"
                                            class="py-3 px-6 border-r border-gray-300 dark:border-gray-700">
                                            ID</th>
                                        <th scope="col"
                                            class="py-3 px-6 border-r border-gray-300 dark:border-gray-700">
                                            Kelas</th>
                            ...
                            <div class="hidden print:block">
                                @php
                                    ...
                                    // Header kolom waktu untuk print (sesuai jenjang jika difilter)
                                    $timeSlots = [];
                                    if (request('level') == 'SD') {
                                        $timeSlots = [
                                            '07:00-07:35',
                                    ...
                                    } elseif (request('level') == 'SMA' || request('level') == 'SMK') {
                                        $timeSlots = [
                                            '07:00-07:45',
                                            '07:45-08:30',
                                            '08:30-09:15',
                                        ...
                                        // Default jika tidak ada filter jenjang
                                        $timeSlots = [
                                            '07:00-07:45',
                                            '07:45-08:30',
                                            '08:30-09:15',
                                ...
                                @if (request('class_id') || request('teacher_id'))
                                    {{-- Jika ada filter kelas/guru, tampilkan jadwal per hari --}}
                                    @foreach ($groupedSchedules as $day => $schedulesPerDay)
                                        <h4
                                            ...
                                            {{ $day }}</h4>
                                        <table
                                            class="w-full text-sm text-left text-gray-500 border border-gray-300 mb-4">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="py-2 px-4 border-r border-gray-300">
                                                        Waktu</th>
                                                    <th scope="col" class="py-2 px-4 border-r border-gray-300">
                                                        Kelas</th> {{-- TAMBAH KOLOM KELAS DI SINI --}}
                                    ...
                                    @endforeach
                                @else
                                    {{-- Jika tidak ada filter kelas/guru, tampilkan jadwal format umum (per kelas dan per hari) --}}
                                    @php
                                        // Kelompokkan jadwal berdasarkan hari dulu
                                    ...
                                    @foreach ($schedulesByDay as $day => $schedulesPerDay)
                                        <h4
                                            class="font-semibold text-lg text-gray-900 mt-4 mb-2 border-b border-gray-300 pb-1">
                                            {{ $day }}</h4>
                                        <table
