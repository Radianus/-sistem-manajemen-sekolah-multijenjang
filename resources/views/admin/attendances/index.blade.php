            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 sm:mb-0">Daftar Absensi</h3>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="py-3 px-6">Dicatat Oleh</th>
                            ...
                            <tbody>
                                @forelse ($attendances as $attendance)
                                    <tr
                                        ...
                                        <td class="py-4 px-6">
                                            {{ $attendance->teachingAssignment->schoolClass->name ?? 'N/A' }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $attendance->teachingAssignment->subject->name ?? 'N/A' }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $attendance->status }}
                                        </td>
                                        <td class="py-4 px-6">
                                            {{ $attendance->recordedByTeacher->name ?? 'N/A' }}
                                        </td>
