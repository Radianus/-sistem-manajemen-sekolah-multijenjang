        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Edit Informasi Kelas:
                        {{ $class->name }}</h3>
                    ...
                    <form method="POST" action="{{ route('admin.classes.update', $class) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="grade_level" class="block mt-1 w-full" type="text" name="grade_level"
                                :value="old('grade_level', $class->grade_level)" placeholder="Cth: 1, 7, 10" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="academic_year" class="block mt-1 w-full" type="text"
                                name="academic_year" :value="old('academic_year', $class->academic_year)" placeholder="Cth: 2024/2025" />
