        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Edit Gambar:
                        {{ $gallery->title }}</h3>
                    ...
                    <form method="POST" action="{{ route('admin.galleries.update', $gallery) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                                :value="old('title', $gallery->title)" required autofocus />
                        ...
                        <div class="mb-4">
                            <x-input-label for="image" :value="__('File Gambar (Opsional)')" />
                            @if ($gallery->image_path)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($gallery->image_path) }}" alt="Gambar Galeri Saat Ini"
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Ukuran maksimal 5MB. Format: JPG,
                                PNG, GIF. Kosongkan jika tidak ingin mengubah.</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="event_date" class="block mt-1 w-full" type="date" name="event_date"
                                :value="old(
                                    'event_date',
                                    $gallery->event_date ? $gallery->event_date->format('Y-m-d') : '',
                                )" />
