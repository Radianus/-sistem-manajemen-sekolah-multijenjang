        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Edit Slider:
                        {{ $slider->title }}</h3>

                    <form method="POST" action="{{ route('admin.hero_sliders.update', $slider) }}"
                        ...
                        <div class="mb-4">
                            <x-input-label for="image" :value="__('Gambar Slider (Opsional)')" />
                            @if ($slider->image_path)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($slider->image_path) }}" alt="Gambar Slider Saat Ini"
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Ukuran maksimal 2MB. Format: JPG,
                                PNG. Kosongkan jika tidak ingin mengubah.</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="link_url" class="block mt-1 w-full" type="url" name="link_url"
                                :value="old('link_url', $slider->link_url)" placeholder="Cth: https://sekolahku.sch.id/berita" />
